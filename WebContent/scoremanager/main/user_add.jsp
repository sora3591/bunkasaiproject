...
<div class="wrap">
  ...
  <div class="card">
    <form method="post" action="<%= request.getContextPath() %>/scoremanager/main/user_add">
      <div class="row">
        <div>
      ...
      <div style="margin-top:12px;">
        ...
        <a class="btn btn-ghost" href="<%= request.getContextPath() %>/scoremanager/main/users_list.jsp">戻る</a>
      </div>
    </form>
