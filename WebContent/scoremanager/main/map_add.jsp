...
<div class="wrap">
  ...
  <div class="card">
    ...
    <div style="margin-top:10px;">
      ...
      <a class="btn btn-ghost" href="map_list.jsp">戻る</a>
    </div>
  </div>
</div>
...
function add(){
  ...
  if(!file){ arr.push({id:uid('m'), name:name.value.trim(), img:''}); saveMaps(arr); return location.href='map_list.jsp'; }
  const reader=new FileReader();
  reader.onload=()=>{ arr.push({id:uid('m'), name:name.value.trim(), img:reader.result}); saveMaps(arr); location.href='map_list.jsp'; };
...
});); saveMaps(arr); location.href='map_list.jsp'; }
</script>
</body></html>